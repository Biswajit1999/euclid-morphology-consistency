...
pytest -q                                   # 12 tests, fixture-based, no network
...
is -0.00158 (95% bootstrap CI [-0.00317, -0.00078], excludes zero;
Wilcoxon signed-rank p=2.9e-13) -- roughly **460x smaller** than the
per-object scatter (MAD=0.731). An earlier version of this README called
...
(Pearson r=0.198). The parametric Sersic index and the non-parametric CAS
concentration statistic show a **moderate positive correlation**
(Spearman r=0.428), consistent with both capturing related morphological
information.
